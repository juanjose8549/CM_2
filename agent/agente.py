...
def crear_agente() -> AgentExecutor:
    ...
    template = (
        ...
        "Ejemplo para preguntas generales (sin usar herramientas):\n"
        "Question: Hola quien eres?\n"
        "Thought: El usuario me saluda, solo debo presentarme\n"
        "Final Answer: Hola, soy un asistente AI experto en gestion de usuarios...\n\n"
        "Comienza:\n\n"
        "Question: {input}\n"
